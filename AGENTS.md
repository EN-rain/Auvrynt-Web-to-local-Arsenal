...
- [PROJECT_ROUTER.md](PROJECT_ROUTER.md)
- [WEB_AGENT_GUIDE.md](WEB_AGENT_GUIDE.md)
- [SOFTWARE_AGENT_GUIDE.md](SOFTWARE_AGENT_GUIDE.md)
- [GODOT_AGENT_GUIDE.md](GODOT_AGENT_GUIDE.md)
- [BLENDER_AGENT_GUIDE.md](BLENDER_AGENT_GUIDE.md)

Before development work:
1. Detect the active project or subproject using root indicators.
2. Read [PROJECT_ROUTER.md](PROJECT_ROUTER.md).
