...
function formHtml(params: {
  ...
  const scopeText = params.scopes.length > 0 ? params.scopes.join(" ") : "auvrynt";
...
${hiddenFields}
        ...
        <button type="submit">Authorize Auvrynt</button>
      </form>
    </main>
  </body>
</html>`;
