export const AUVRYNT_THEME_CSS = `
:root {
  color-scheme: dark;
  --auvrynt-bg-deep: #0b0714;
  --auvrynt-bg: #11051f;
  --auvrynt-surface: #1e0b36;
  --auvrynt-surface-soft: rgba(30, 11, 54, 0.78);
  --auvrynt-code: rgba(12, 6, 24, 0.78);
  --auvrynt-text: #fbf7ff;
  --auvrynt-text-secondary: #c4b5fd;
  --auvrynt-text-muted: #a78bfa;
  --auvrynt-accent: #c084fc;
